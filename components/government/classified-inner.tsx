...
const CLASS_ACCENT: Record<
  string,
  { chip: string; border: string; text: string }
> = {
  PÚBLICO: {
    chip: "bg-[var(--c-public)] text-white",
    border: "border-l-[var(--c-public)]",
    text: "text-[var(--c-public)]",
  },
  CONFIDENCIAL: {
    chip: "bg-[var(--c-confidential)] text-white",
    border: "border-l-[var(--c-confidential)]",
    text: "text-[var(--c-confidential)]",
  },
  SECRETO: {
    chip: "bg-[var(--c-secret)] text-white",
    border: "border-l-[var(--c-secret)]",
    text: "text-[var(--c-secret)]",
  },
  ULTRASSECRETO: {
    chip: "bg-[var(--c-ultra)] text-white",
    border: "border-l-[var(--c-ultra)]",
    text: "text-[var(--c-ultra)]",
  },
};
