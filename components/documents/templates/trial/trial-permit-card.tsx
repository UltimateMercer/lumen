...
import { PermitCheckTable } from "../permit-card";

interface TrialPermitCardFrontmatter extends DocumentFrontmatter {
  id: string;
  registryName: string;
  age: number;
  birthDate: string;
...
export function TrialPermitCard({ doc }: { doc: ArchiveDocument }) {
  const fm = doc.frontmatter as unknown as TrialPermitCardFrontmatter;
